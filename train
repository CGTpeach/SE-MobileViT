...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str,
                        default=r"/public/home/chenguotao2021/classification/MobileViT/data/4classt_t/train/")

    # 预训练权重路径，如果不想载入就设置为空字符
    parser.add_argument('--weights', type=str, default="/public/home/chenguotao2021/classification/MobileViT/model_weight/mobilevit_xxs.pt",
